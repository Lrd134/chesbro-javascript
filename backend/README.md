This application is a SPA, or Single Page Application. This application allows you to create a user with a username, then create a score by playing the game.
